...
const int32 PATCH_VERSION = 3;
const TCHAR* VERSION_PREFIX = TEXT("alpha");
const constexpr int32 NUMBER_VERSION = MAJOR_VERSION * 1000 + MINOR_VERSION * 100 + PATCH_VERSION * 10;
...
const TCHAR* GetStringVersionT()
{
	...
	StringVersion = FString::PrintF(TEXT("v%i.%i.%i-%s"), MAJOR_VERSION, MINOR_VERSION, PATCH_VERSION, VERSION_PREFIX);
	return *StringVersion;
}
