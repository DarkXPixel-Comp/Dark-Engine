...
FORCEINLINE D3D12_RESOURCE_STATES GetD3D12ResourceState(ERHIAcces InRHIAccess)
{
	switch (InRHIAccess)
	{
	case ERHIAcces::CpuRead: return D3D12_RESOURCE_STATE_COPY_SOURCE;
	case ERHIAcces::Present: return D3D12_RESOURCE_STATE_PRESENT;
	case ERHIAcces::VertexOrIndexBuffer: return D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER | D3D12_RESOURCE_STATE_INDEX_BUFFER;
	case ERHIAcces::SRVGraphics: return D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE;
	case ERHIAcces::UAVCompute:
	case ERHIAcces::UAVGraphics: return D3D12_RESOURCE_STATE_UNORDERED_ACCESS;
	case ERHIAcces::RTV: return D3D12_RESOURCE_STATE_RENDER_TARGET;
	case ERHIAcces::CopyDesc: return D3D12_RESOURCE_STATE_COPY_DEST;
	case ERHIAcces::DSVWrite: return D3D12_RESOURCE_STATE_DEPTH_WRITE;
	}
