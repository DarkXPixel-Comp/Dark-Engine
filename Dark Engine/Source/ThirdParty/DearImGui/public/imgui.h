...
namespace ImGui
{
    ...
    IMGUI_API void             BeginLayout(ImGuiID id, ImGuiLayoutType type, ImVec2 size, float align);
    IMGUI_API void             EndLayout(ImGuiLayoutType type);
    IMGUI_API void             PushLayout(ImGuiLayout* layout);
    IMGUI_API void             PopLayout(ImGuiLayout* layout);
