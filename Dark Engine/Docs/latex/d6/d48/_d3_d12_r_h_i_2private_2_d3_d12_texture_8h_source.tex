...
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \ \ \ \ \mbox{\hyperlink{struct_f_r_h_i_descriptor_handle}{FRHIDescriptorHandle}}\ \mbox{\hyperlink{class_f_d3_d12_texture_a42aaa626af58cf4a2446d24c4db82bf3}{GetBindlessHandle}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \ \ \ \ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_f_d3_d12_shader_resource_view}{FD3D12ShaderResourceView}}*\ \mbox{\hyperlink{class_f_d3_d12_texture_a8472209bbbadb29a713d92444466dae8}{GetShaderResourceView}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_f_d3_d12_texture_a18e70b321014f64e1808faf067c7fe4a}{ShaderResourceView}}.get();\ \}}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00044\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{_platform_8h_a8c7a127091efbdfc5a16939041653e05}{uint32}}\&\ DestStride,\ \mbox{\hyperlink{_platform_8h_afddf25cca147311c233b23a9d3329bb4}{uint64}}*\ OutLockedByteCount\ =\ \textcolor{keyword}{nullptr});}
...
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ D3D12\_TEXTURE\_COPY\_LOCATION\&\ SourceCopyLocation);}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keyword}{static}\ D3D12\_RESOURCE\_DESC\ \mbox{\hyperlink{class_f_d3_d12_texture_a71bab57ec5e814552efd074dd96fdcff}{GetResourceDescFromTextureDesc}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_f_r_h_i_texture_create_desc}{FRHITextureCreateDesc}}\&\ InDesc);}
\DoxyCodeLine{00051\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00052\ \ \ \ \ TArray<TSharedPtr<class\ FD3D12RenderTargetView>>\ \mbox{\hyperlink{class_f_d3_d12_texture_a18c44ef899d4c6385d466dcd24cf3793}{RenderTargetViews}};}
\DoxyCodeLine{00053\ \ \ \ \ TSharedPtr<class\ FD3D12ShaderResourceView>\ \mbox{\hyperlink{class_f_d3_d12_texture_a18e70b321014f64e1808faf067c7fe4a}{ShaderResourceView}};}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00056\ \ \ \ \ D3D12\_GPU\_VIRTUAL\_ADDRESS\ GPUVirtualAddress;}
\DoxyCodeLine{00057\ \ \ \ \ TRefCountPtr<FD3D12Resource>\ \mbox{\hyperlink{_d3_d12_main_8h_ab8eaee8f45f36954297ee6146eb6db20}{Resource}};}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \ \ TMap<uint32,\ FD3D12LockedResource*>\ LockedMap;}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \};}
